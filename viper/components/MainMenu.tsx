...
const MainMenu: React.FC<Props> = ({
  ...
  // View state: 'auth' | 'profile-completion' | 'main' | 'settings' | 'user-profile' | 'leaderboard'
  ...
  const [hasUnseenQuests, setHasUnseenQuests] = useState(true); // Default to true so it bounces initially
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center z-50 bg-dark-bg/90 backdrop-blur-sm">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-md p-8">
        ...
        {view === "auth" && (
          <div
            className="w-full glass-panel p-8 rounded-2xl animate-in zoom-in-95 duration-300 max-h-[80vh] overflow-y-auto custom-scrollbar"
          ...
          <div className="flex flex-col items-center w-full animate-in fade-in slide-in-from-bottom-8 duration-500">
            ...
            >
              ...
              <button
                ...
                className="absolute -top-4 -left-4 w-14 h-14 rounded-full bg-black border-2 flex items-center justify-center shadow-[0_0_15px_rgba(0,243,255,0.5)] hover:scale-110 transition-transform z-30"
                style={{ borderColor: themeColor }}
                title="Lucky Wheel"
              >
              ...
              <button
                ...
                className={`absolute -top-4 -right-4 w-14 h-14 rounded-full bg-black border-2 flex items-center justify-center shadow-[0_0_15px_rgba(255,215,0,0.5)] hover:scale-110 transition-transform z-30 ${hasUnseenQuests ? "animate-bounce" : ""}`}
                style={{ borderColor: themeColor }}
        ...
        {view === "user-profile" && currentUser && (
          <div
            className="w-full relative glass-panel p-6 rounded-2xl animate-in fade-in zoom-in-95 duration-300 border shadow-[0_0_30px_rgba(0,0,0,0.5)] max-h-[90vh] overflow-y-auto custom-scrollbar"
            style={{ borderColor: `${themeColor}40` }}
          >
            <button
              onClick={() => {
              ...
              {getLeaderboard().length === 0 ? (
                ...
                getLeaderboard().map((entry, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span
                        className={`font-bold w-6 text-center ${idx === 0 ? "text-yellow-400" : idx === 1 ? "text-gray-300" : idx === 2 ? "text-amber-600" : "text-gray-500"}`}
                      >
                        #{idx + 1}
                      </span>
                      <div className="flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(["minimal", "full"] as const).map((fx) => (
                    <button
                      ...
                      className={`px-2 py-2 rounded text-xs font-bold uppercase border transition-all ${settings.visualEffects === fx
                ...
                <div className="grid grid-cols-3 gap-2">
                  {(["mouse", "joystick", "hybrid"] as const).map((scheme) => (
                    <button
                      ...
                      className={`px-2 py-2 rounded text-xs font-bold uppercase border transition-all ${settings.controlScheme === scheme
                        ? "bg-neon-blue/20 text-neon-blue border-neon-blue"
                        : "bg-black/40 text-gray-500 border-white/5 hover:bg-white/5"
                        }`}
                      style={{
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(
                    ...
                    <button
                      ...
                      className={`px-2 py-2 rounded text-xs font-bold uppercase border transition-all ${settings.gameMode === mode
                        ? "bg-neon-blue/20 text-neon-blue border-neon-blue"
                        : "bg-black/40 text-gray-500 border-white/5 hover:bg-white/5"
                        }`}
                      style={{
